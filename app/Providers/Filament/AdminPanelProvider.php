                ...
                return $builder->groups([
                    ...
                    NavigationGroup::make('Conferences')
                        ->items([
                            ...
                            ...InstituteResource::getNavigationItems(),
                    ...
                    NavigationGroup::make('Administrative')
                        ->items([
                            ...UserResource::getNavigationItems(),
                            ...ConferenceVisitorResource::getNavigationItems(),
                            ...NewsletterSubscriberResource::getNavigationItems(),
                            ...SearchTermsResource::getNavigationItems(),
                        ]),
                ]);
            });
    }
